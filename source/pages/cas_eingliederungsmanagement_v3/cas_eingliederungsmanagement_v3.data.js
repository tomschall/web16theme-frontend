...
var data = _.merge(defaultData, {
		meta: {
			title: 'CAS Eingliederungsmanagement v3',
		...
		widgets: {
			...
			sidebarContact: _.assign(requireNew('../../widgets/contact/contact.data.js'), {
				persons: [
					{
			...
			productBar: _.assign(requireNew('../../widgets/productbar/productbar.data.js'))
		}
	});
