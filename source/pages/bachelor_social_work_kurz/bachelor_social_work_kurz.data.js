...
var data = _.merge(defaultData, {
	meta: {
		title: 'Bachelor of Arts in Sozialer (kurz)',
	},
	title: 'Bachelor of Arts in Sozialer (kurz)',
	text: 'Die Hochschule für Soziale Arbeit.',
	widgets: {
		header: _.assign(
			{
		...
		informationAccordeon: _.assign(
			requireNew('../../widgets/accordeon/accordeon.data.js'),
			{}
		),
		organisationAccordeon: _.assign(
			requireNew('../../widgets/accordeon/accordeon.data.js'),
			{
				entries: [
					{
		...
		nextCoursesAccordeon: _.assign(
			requireNew(
				'../../widgets/application_accordeon/application_accordeon.data.js'
			),
			{}
		),
		...
		querlinks: _.assign(
			requireNew('../../widgets/extendedlinks/extendedlinks.data.js')
		),
		tabnavigation: requireNew(
			'../../widgets/tabnavigation/tabnavigation.data.js'
		),
		locationAccordeon: _.assign(
			requireNew('../../widgets/accordeon/accordeon.data.js'),
			{
				entries: [
					{
		...
		mobileContentNavigation: requireNew(
			'../../widgets/mobile_content_navigation/mobile_content_navigation.data.js'
		),
