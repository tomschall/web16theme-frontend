...
;(function($, undefined) {
	...
	Widget.prototype.init = function() {
		...
		this.$element.find(this.options.domSelectors.slider).slick({
			...
			prevArrow: '<button data-carousel="button" ontouchstart="" class="widg_carousel__prev not-default">Vorherige</button>',
			nextArrow: '<button data-carousel="button" ontouchstart="" class="widg_carousel__next not-default">Nächste</button>',
			autoplay: true,
   ...
   */
	...
	Widget.prototype.resetButtonEventListener = function() {
		$('button.widg_carousel__prev, button.widg_carousel__next').on('touchstart', function() {
