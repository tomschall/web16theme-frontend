...
<section>
	...
	<br />
	<button on:click={showPopupWithProps}
		>Show a popup from an outside component with custom props!</button
	>
	<p style="padding: 500px 0;">Just some text to overflow the body</p>
	<button on:click={showPopup}>Show a popup from an outside component!</button>
</section>
