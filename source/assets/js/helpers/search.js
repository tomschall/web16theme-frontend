...
;(function($, undefined) {
	...
	events = {
		...
		listEntryTemplates = {
			...
			categorySearch: {
				training: '<tr class="cat_page_result search__result--item" data-clickable="true" ><td class="search__cell search__cell-title"><a href="{{combinedURL}}" class="search__cell-anchor">{{Title}}</a></td><td>{{short_eduproducttype}}</td><td>{{faculty}}</td><td>{{location}}</td><td data-searchpage="url"><a href="{{combinedURL}}"></a><span class="search__result-arrow"></span></td></tr>',
