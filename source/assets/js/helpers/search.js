...
;(function($, undefined) {
	...
	events = {
		...
		listEntryTemplates = {
			...
			categorySearch: {
				training: '<tr class="cat_page_result search__result--item" data-clickable="true" ><td class="search__cell search__cell-title"><a href="{{combinedURL}}" class="search__cell-anchor">{{Title}}</a></td><td>{{taxonomy_eduproducttype}}</td><td>{{taxonomy_subjectarea}}</td><td>{{city}}</td><td data-searchpage="url"><a href="{{combinedURL}}"></a><span class="search__result-arrow"></span></td></tr>',
				...
				studies: '<tr class="cat_page_result search__result--item" data-clickable="true"><td class="search__cell"><a href="{{combinedURL}}" class="search__cell-anchor">{{Title}}</a></td><td>{{type}}</td><td>{{fields}}</td><td>{{fhnw_location}}</td><td data-searchpage="url"><a href="{{combinedURL}}"></a><span class="search__result-arrow"></span></td></tr>'
			},
