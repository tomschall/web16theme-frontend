...
declare -a search_pages=("svelte_searchpage" "search_all" "search_documents" "search_edu" "search_events" "search_expertises" "search_filter" "search_irf" "search_other" "search_profiles" "search_web" "search_news")
